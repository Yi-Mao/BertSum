...
from models.encoder import Classifier, RNNEncoder, TransformerInterEncoder
...
class Bert(nn.Module):
    def __init__(self, pretrained_bert_path, load_pretrained_bert,
                 bert_config):
        super(Bert, self).__init__()
        if load_pretrained_bert:
            self.model = BertModel.from_pretrained(pretrained_bert_path)
        else:
...
class Summarizer(nn.Module):
    def __init__(self,
        ...
        self.args = args
        self.device = device
        self.bert = Bert(args.pretrained_bert_path, load_pretrained_bert,
                         bert_config)
