...
model_flags = [
    'hidden_size', 'ff_size', 'heads', 'inter_layers', 'encoder', 'ff_actv',
    'use_interval', 'rnn_size'
]
...
def validate(args, device_id, pt, step):
    ...
    model = Summarizer(
        args, device, load_pretrained_bert=False, bert_config=config)
...
def train(args, device_id):
    init_logger(os.path.join(args.model_path, args.log_file))
...
if __name__ == '__main__':
    ...
    parser.add_argument("-pretrained_bert_path", required=True)
    parser.add_argument("-bert_data_path", default='../bert_data/cnndm')
    parser.add_argument("-model_path", default='../models/')
    parser.add_argument("-result_path", default='../results/cnndm')
    parser.add_argument("-temp_dir", default='../temp')
    parser.add_argument(
        "-bert_config_path", default='../bert_config_uncased_base.json')
    parser.add_argument("-rouge_dir", default='')
